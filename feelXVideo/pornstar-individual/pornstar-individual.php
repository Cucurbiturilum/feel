...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/pornstar-individual.css">
                ...
                <div class="row">
                    <div class="col-12 position-relative">
                        ...
                        <div class="description position-absolute d-flex flex-column">
                            ...
                            <p class="banner-text text-white text-left">
                                Lorem ipsum doler it smit, ay tan baon changi ha
                            </p>
                            <p class="banner-text text-white text-left">
                                Lorem ipsum doler it smit, ay tan baon changi ha
                            </p>
                            <div class="statistic text-right text-white">
                                <p class="statistic-item d-inline-block mr-3">
                                    <strong>13 M</strong>
                                    <small>Views</small>
                                </p>
                                <p class="statistic-item d-inline-block">
                                    <strong>33 k</strong>
                                    <small>Likes</small>
                                </p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 mb-5">
                        <div class="card rounded-0 p-0 bg-transparent border-0">
                            <div class="card-header p-0 rounded-0">
                                ...
                                <p class="card-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                         version="1.1" id="Capa_1" x="0px" y="0px" width="40" height="40"
                                         viewBox="0 0 163.861 163.861"
                                         style="enable-background:new 0 0 163.861 163.861;" xml:space="preserve"
                                         class="">
                            ...
                            <div class="card-body">
                                <p class="video-title text-left text-white">
                                    Little latina hotie drinks cum
                                </p>
